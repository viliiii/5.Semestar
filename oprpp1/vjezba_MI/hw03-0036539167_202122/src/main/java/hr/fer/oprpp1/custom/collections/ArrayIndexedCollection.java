...
public class ArrayIndexedCollection<T> implements List<T>{
     ...
     */
    private static class ElementsGetterArrIndColl<T> implements ElementsGetter<T>{
        int indToGet = 0;
         ...
         */
        public ElementsGetterArrIndColl(ArrayIndexedCollection<T> collection) {
            coll =  collection;
        ...
        public T getNextElement(){
            ...
            if(hasNextElement()){
                return (T) coll.elements[indToGet++];
            }else{
     ...
     */
    @Override
    public ElementsGetterArrIndColl<T> createElementsGetter(){
