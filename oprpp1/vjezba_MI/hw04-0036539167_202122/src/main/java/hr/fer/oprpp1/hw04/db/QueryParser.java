...
public class QueryParser {
    ...
    private boolean statisticsRequiredFlag = false;

    private LinkedList<TokenType> requiredColumns;
    ...
    public void parse(){
        ...
        while (token.getType() != TokenType.EOF){
            ...
            listConEx.add(new ConditionalExpression(FieldGetter, StringLiteral, ComparisonOperator));

            if(token.getType() == TokenType.STATISTICS){
                statisticsRequiredFlag = true;
                token = queryLexer.nextToken();
            }
    ...
    public boolean isStatisticsRequiredFlag() {
        return statisticsRequiredFlag;
    }

    public void setStatisticsRequiredFlag(boolean statisticsRequiredFlag) {
        this.statisticsRequiredFlag = statisticsRequiredFlag;
    }

    public LinkedList<TokenType> getRequiredColumns() {
    ...
    public static class Lexer{
        ...
        public Token nextToken() {
            ...
            //STATISTICS REQUIRED
            if(data[currentIndex] == 'w'){
                currentIndex = currentIndex + 15;
                return new Token(TokenType.STATISTICS, "statistics");
            }
