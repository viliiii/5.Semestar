...
public class LinkedListIndexedCollection<T> implements List<T>{
     ...
     */
    private static class ElementsGetterListInd<T> implements ElementsGetter<T>{

        ListNode current;
        LinkedListIndexedCollection<T> coll;
         ...
         */
        public ElementsGetterListInd(LinkedListIndexedCollection<T> collection) {
            coll = collection;
